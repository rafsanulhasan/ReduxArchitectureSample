    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                ...
                spa.Options.SourcePath = AppPaths.AngularApp;

                if (env.IsDevelopment())
                {
                    spa.UseAngularCliServer(npmScript: NpmScripts.AngluarScript);
                    spa.UseProxyToSpaDevelopmentServer(Configuration[SpaBaseUrl] ?? AppHosts.AngularApp.FullHost);
                }
            });
        }
    }
